...
% 'sets of registration' is unclear. Perhaps: 'sets of template registration spaces' so that the various noise reduction strategies can be more readily compared. 
...
%This need is further emphasized by a recent survey of INDI users in which 70\% of the respondents indicated that the availability of statistical derivatives is either very important or absolutely critical to the neuroimaging community. % CC: Should we include stats or remove?
