...
%DIF ADD Bellec_ADHD200_2016.tex                                                                      Mon May 23 00:20:22 2016
...
\DIFdelbegin %DIFDELCMD < \author[label0,label5]{%%%
\DIFdel{Daniel S. Margulies}\DIFdelend \DIFaddbegin \author[label0,label1,label5]{\DIFadd{Yassine Benhajali}\DIFaddend }
\DIFdelbegin %DIFDELCMD < \address[label5]{Max Planck Research Group for Neuroanatomy \& Connectivity, Max Planck Institute for Human Cognitive and Brain Sciences, Leipzig, Germany}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \address[label5]{D\'epartement d'Anthropologie, Universit\'e de Montr\'eal, Montr\'eal, CA}
\ead{yanamarji@gmail.com}

\author[label0,label6]{\DIFadd{Daniel S. Margulies}}
...
\DIFaddend \ead{margulies@cbs.mpg.de}

\DIFdelbegin %DIFDELCMD < \author[label0,lab6,lab7]{%%%
\DIFdelend \DIFaddbegin \author[label0,lab7,lab8]{\DIFaddend R. Cameron Craddock\corref{cor1}}
\DIFdelbegin %DIFDELCMD < \address[lab6]{Computational Neuroimaging Laboratory, Center for Biomedical Imaging and Neuromodulation, Nathan S. Kline Institute for Psychiatric Research, Orangeburg, NY, USA}
%DIFDELCMD < \address[lab7]{Center for the Developing Brain, Child Mind Institute, New York, NY, USA}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \address[lab7]{Computational Neuroimaging Laboratory, Center for Biomedical Imaging and Neuromodulation, Nathan S. Kline Institute for Psychiatric Research, Orangeburg, NY, USA}
\address[lab8]{Center for the Developing Brain, Child Mind Institute, New York, NY, USA}
\DIFaddend \ead{ccraddock@nki.rfmh.org}
...
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{In line with the original purpose of the }\DIFaddend ADHD-200 \DIFdelbegin \DIFdel{Sample was originally created to identify rs-fMRI based biomarkers of ADHD; however, }\DIFdelend \DIFaddbegin \DIFadd{Global competition, most works derived from the ADHD-200 Preprocessed initiative proposed new machine learning techniques and their main application on real data was to predict clinical diagnosis from the ADHD-200 Preprocessed sample. The most frequently used derivatives have been Athena preprocessed fMRI volumes \mbox{%DIFAUXCMD
...
. Some works also based their main analysis on the Burner, either in isolation \mbox{%DIFAUXCMD
...
. A few papers utilized the Athena ICA, ReHo and fALFF maps \mbox{%DIFAUXCMD
...
. Some publications also made a more marginal use of }\DIFaddend the \DIFdelbegin \DIFdel{dataset }\DIFdelend \DIFaddbegin \DIFadd{ADHD-200 Preprocessed repository, by re-using the CC200 or CC400 functional brain parcellations \mbox{%DIFAUXCMD
...
\cite{Rangarajan2014, Liang2012, Tabas2014, Rangarajan2015, Mahanand2013, Lifshitz2012, Fujita2013, Ji2011, Li2015, Li2013, Liu2012, DosSantosSiqueira2014, Olivetti2014, Han2015, Wang2013a, Dey2014, Bellec2012, Bohland2012, Chang2012, Cheng2012, Colby2012, Dai2012, Dey2012, Eloyan2012, Olivetti2012, Sato2012a, Subramanian2013, Carmona2015, Hou2015, Deshpande2015, She2014, Lavoie-Courchesne2012b, Chen2015, Nunez-Garcia2015, Solmaz2012, Anderson2014, KadkhodaeianBakhtiari2012, Sato2013, Kyeong2015, Sato2012, Takahashi2012, He2013, Kong2013, Yao2013, Yang2015, Ahn2015, Fujita2014, Reiss2014}}%DIFAUXCMD
}\DIFaddend , three PhD theses \cite{Colby2012a, Dey2014phd, Zhang2012}, three master's dissertations \cite{VanGalenLast2011, Vidal2014, Wang2013}\DIFaddbegin \DIFadd{, }\DIFaddend and one patent \cite{Dey2013} derived from the release in just over three years\DIFdelbegin \DIFdel{, with further publications }\DIFdelend \DIFaddbegin \DIFadd{. Further publications are either }\DIFaddend in press or under review\DIFaddbegin \DIFadd{, and an updated list of publications will be maintained on the Mendeley platform}\footnote{\url{https://www.mendeley.com/groups/4198361/adhd-200-preprocessed/}}\DIFadd{. Although there was clearly a peak in usage around the ADHD-200 Global competition, there has been a sustained ammount of downloads and publications since then, see Figure \ref{fig:usage}, which we take as a demonstration of a long-term interest from the community in this resource}\DIFaddend . 
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{We also found interesting that a handful of methodological works used the ADHD-200 Preprocessed sample as one application in a series of benchmarks that could be as varied as positron emission tomography in Alzheimer's disease \mbox{%DIFAUXCMD
\citep{Yang2015}}%DIFAUXCMD
...
. This suggests that fully processed, easy-to-access samples could dramatically accelerate the cross-polinization of disciplines.
}\par
\DIFaddend The impact of the ADHD-200 Preprocessed repository demonstrated the need for reducing computational barriers to participation in discovery neuroscience, including but not limited to machine learning competitions based on neuroimaging data. \DIFdelbegin \DIFdel{We do not plan to expand or update the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend ADHD-200 Preprocessed release \DIFdelbegin \DIFdel{as such, which we hope }\DIFdelend \DIFaddbegin \DIFadd{has contributed and }\DIFaddend will continue to \DIFdelbegin \DIFdel{serve as a legacy benchmark dataset}\DIFdelend \DIFaddbegin \DIFadd{contribute to respond to that need}\DIFaddend . We still believe that a much larger-scale effort will be necessary to unlock the full potential of openly shared neuroimaging data in the service of accelerating neuroimaging research. \DIFdelbegin \DIFdel{Current initiatives include a larger number of alternative analytical workflows as well as a careful harmonization of processing, quality control, and data packaging strategies}\DIFdelend \DIFaddbegin \DIFadd{In line with the grassroots, open science ethos of the Neurobureau, new contributors interested in sharing derivatives of ADHD-200 or other open imaging data repository can contact us via a forum}\footnote{\url{http://www.nitrc.org/forum/?group_id=383}}\DIFadd{. We are also actively seeking for contributions, notably during brainhack events\mbox{%DIFAUXCMD
